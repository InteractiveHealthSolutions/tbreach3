...
public class RegexUtil
{
	...
	public static final String	binrayAnswerPattern		= "[T|F|Y|N]|[tT]rue|TRUE|[yY]es|YES|[fF]alse|FALSE|[nN]o|NO";
	public static final String	emailPattern			= "^[_A-Za-z0-9-]+(\\.[_A-Za-z0-9-]+)*@[A-Za-z0-9]+(\\.[A-Za-z0-9]+)*(\\.[A-Za-z]{2,})$";
	public static final String	contactNoPattern		= "[+0-9]+[0-9]+";
	...
	/**
	 * Checks whether given input is a true/false or yes/no answer
	 * 
	 * @param string
	 * @return
	 */
	public static boolean isBinaryAnswer (String string)
	{
		try
		{
			return string.matches (binrayAnswerPattern);
		}
		catch (Exception e)
		{
			e.printStackTrace ();
