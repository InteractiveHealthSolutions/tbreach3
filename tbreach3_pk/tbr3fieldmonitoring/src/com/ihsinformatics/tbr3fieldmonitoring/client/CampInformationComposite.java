...
public class CampInformationComposite extends Composite implements ClickHandler
{
	...
	HourMinutePicker campStartHourMinutePicker = new HourMinutePicker(PickerFormat._12_HOUR);

	private Label campEndTimeLabel = new Label("Camp End Time");
	private HourMinutePicker campEndHourMinutePicker = new HourMinutePicker(PickerFormat._12_HOUR);
	
	private Label campExpenseStaffLabel = new Label("Per Camp Expense for Staff");
	private TextBox campExpenseStaffTextBox = new TextBox();
	
	private Label campExpenseOthersLabel = new Label("Per Camp Expense for Others");
...
//		loginFlexTable.setBorderWidth(2);
		...
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(1, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(2, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(3, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(4, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(5, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(6, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(7, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(8, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(9, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(10, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(11, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(12, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(13, 1, HasHorizontalAlignment.ALIGN_LEFT);
		campInfoFlexTable.getCellFormatter().setHorizontalAlignment(14, 1, HasHorizontalAlignment.ALIGN_LEFT);
