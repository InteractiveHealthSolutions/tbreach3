...
public class TestEntryComposite extends Composite implements ClickHandler
{
	...
	private RadioButton genderMaleRadioButton = new RadioButton("genderRadioGroup", "Male");
	private RadioButton genderFemaleRadioButton = new RadioButton("genderRadioGroup", "Female");
	
	private Label testTypeLabel = new Label("Test Type");
	private FlowPanel testTypeFlowPanel = new FlowPanel();
	private RadioButton testDiabetesRadioButton = new RadioButton("testTypeRadioGroup", "Diabetes");
	private RadioButton testSpirometryRadioButton = new RadioButton("testTypeRadioGroup", "Spirometry");
