...
//		loginButton.setStyleName("button:active");
		...
		loginFlexTable.getCellFormatter().setVerticalAlignment(1, 1, HasVerticalAlignment.ALIGN_MIDDLE);
		loginFlexTable.getCellFormatter().setVerticalAlignment(0, 1, HasVerticalAlignment.ALIGN_MIDDLE);
...
//			service.getLocation("101000 Sehatmand Zindagi Centre Korangi", new AsyncCallback<Location>()
//			{
//				@Override
...
//			});
			...
			if (TBR3Client.get(userTextBox).equals ("") || TBR3Client.get (passwordTextBox).equals (""))
			{
			...
			try
			{
				service.authenticate(TBR3Client.get(userTextBox), TBR3Client.get(passwordTextBox), new AsyncCallback<String>()
				{
					@Override
