...
public class DailyVisitComposite extends Composite implements ClickHandler
{
	...
	private HourMinutePicker arrivalHourMinutePicker = new HourMinutePicker(PickerFormat._12_HOUR);
	
	private Label departureTimeLabel = new Label("Departure Time");
	private HourMinutePicker departureHourMinutePicker = new HourMinutePicker(PickerFormat._12_HOUR);
	
	private Label metGpLabel = new Label("Met GP");
	private FlowPanel metGpFlowPanel = new FlowPanel();
	private RadioButton metGpYesRadioButton = new RadioButton("metGpRadioGroup", "Yes");
	private RadioButton metGpNoRadioButton = new RadioButton("metGpRadioGroup", "No");
	
	private Label givenCouponsLabel = new Label("Given Coupons/Rx Pads");
	private FlowPanel givenCouponsFlowPanel = new FlowPanel();
	private RadioButton givenCouponsYesRadioButton = new RadioButton("givenCouponsRadioGroup", "Yes");
	private RadioButton givenCouponsNoRadioButton = new RadioButton("givenCouponsRadioGroup", "No");
	...
	private RadioButton marketingYesRadioButton = new RadioButton("marketingRadioGroup", "Yes");
	private RadioButton marketingNoRadioButton = new RadioButton("marketingRadioGroup", "No");
	
	private Label marketingDescriptionLabel = new Label("Marketing Activity Description");
	private TextBox marketingDescriptionTextBox = new TextBox();

	private Label marketingBudgetItemsLabel = new Label("MR Marketing Budget Items");
	private TextBox marketingBudgetItemsTextBox = new TextBox();
	
	private Label amountLabel = new Label("Amount");
	private IntegerBox amountIntegerBox = new IntegerBox(); // takes only integer
	
	private Label institutionalMarketingItemsLabel = new Label("Institutional Marketing Items");
...
//		loginFlexTable.setBorderWidth(2);
		...
		dailyVisitFlexTable.setWidget(14, 1, institutionalMarketingItemsListBox);
		...
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(1, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(2, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(3, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(4, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(5, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(6, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(7, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(8, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(9, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(10, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(11, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(12, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(13, 1, HasHorizontalAlignment.ALIGN_LEFT);
		dailyVisitFlexTable.getCellFormatter().setHorizontalAlignment(14, 1, HasHorizontalAlignment.ALIGN_LEFT);
