...
public class Patient implements java.io.Serializable
{
	...
	public Patient (String patientId, String mrNo, Date dateScreened, String team, String suspectedBy, String diseaseSuspected, Date dateSuspected, Boolean diseaseConfirmed, Date dateConfirmed,
			String confirmationSource, String confirmationRemarks, String diseaseType, String patientType, String patientStatus, String hivStatus, String treatmentSite, Date dateClosed)
	{
		this.patientId = patientId;
		this.mrNo = mrNo;
	...
	{
		return patientId + ", " + mrNo + ", " + dateScreened + ", " + team + ", " + suspectedBy + ", " + diseaseSuspected + ", " + dateSuspected + ", " + diseaseConfirmed + ", " + dateConfirmed
				+ ", " + confirmationSource + ", " + confirmationRemarks + ", " + diseaseType + ", " + patientType + ", " + patientStatus + ", " + hivStatus + ", " + treatmentSite + ", " + dateClosed;
	}
}
