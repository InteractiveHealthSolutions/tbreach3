...
public class TBReachMainMIDlet extends MIDlet {
	...
	public TBReachMainMIDlet() {
		...
		preg = new PatientRegistration("Регистрация пациента", this);
		bslfrm = new BaselineForm("Исходные данные", this);
		mtrfrm = new MonitoringForm("Мониторинг", this);
		surfrm = new SurveyForm("Мнение пациента", this);
