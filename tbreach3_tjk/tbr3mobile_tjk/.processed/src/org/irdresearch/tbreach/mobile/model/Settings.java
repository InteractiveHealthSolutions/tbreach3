...
public class Settings {
	...
	private static final String DEFAULT_BASE_URL = "http://217.11.182.107:8080/tbr3mobileweb/tbrmobile.jsp";
	private static final String DEFAULT_SECONDARY_URL =  "http://217.11.182.107:8080/tbr3mobileweb/tbrmobile.jsp";
 ...
 */
	...
	private void loadSettings(boolean suspectId, boolean suspectConfirm, boolean suspectVerify, boolean patientInfo, boolean patientTBInfo, boolean patientGPS, boolean patientSputum, boolean sputumResult,
			...
			boolean drgdisp, boolean dotsAssign, boolean addrUpdate, boolean patVerify, boolean naaf, boolean patReg, boolean baselineForm, boolean monitoringForm, boolean surveyForm) {
...
*/		listItems[MenuItem.MENU_NEW_CT_SUSPECT].setShow(false);
		...
		listItems[MenuItem.MENU_BASELINEFORM].setShow(baselineForm);
		listItems[MenuItem.MENU_MONITORINGFORM].setShow(monitoringForm);
		listItems[MenuItem.MENU_SURVEYFORM].setShow(surveyForm);
...
//boolean suspectId, boolean suspectConfirm, boolean suspectVerify, boolean patientInfo, boolean patientTBInfo, boolean patientGPS, boolean patientSputum, boolean refusal, boolean baselineTreatment, boolean followupTreatment, boolean drugAdmin, boolean endFollowup) {			
			...
			loadSettings(true,false,false,false,false,false,false,false,false, false,false, false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false, false, false, false, false);
		 	break;
		
		case UserType.USER_TYPE_GP:
			loadSettings(false,false,false,false,false,false,false,false,false,true,false,false,true,false,false,false,false,true,true,true,false,true,true,false,false,true,true,false,false,false,false, false,false, false, false);
			break;
		
		case UserType.USER_TYPE_MONITOR:
			loadSettings(false,false,true,true,true,true,true,true,true,true,false,false,true,true,false,true,true,true,true,true,true,true,true,true,false,true,true,true,true,true,true, false,false, false, false);
			break;
		...
		case UserType.USER_TYPE_DOCTOR:
			loadSettings(false, false, false, false, false, false, false, false, false, false, false, false, false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false, false, false, false, false);
			break;
		}
	}
